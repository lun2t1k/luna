...
const links = [
  ...
  {title: 'copy palette', href: 'https://copypalette.app/', image: copypalette, tags: ['palettes']},
  {
    ...
    href: 'https://mybrandnewlogo.com/color-palette-generator',
    image: colorpalettegenerator,
    tags: ['palettes', 'generator']
  },
  ...
  {title: 'color hexa', href: 'https://www.colorhexa.com/', image: colorhexa, tags: ['palettes', 'information']},
  {
    ...
    href: 'https://www.realtimecolors.com/?colors=050316-fbfbfe-2f27ce-ff00f2-1a13e6&fonts=Poppins-Poppins',
